...
cscript configure.js compiler=msvc cruntime=/MDd debug=no bindir=%INSTALL_BIN_DIR% libdir=%INSTALL_LIB_DIR% include="%INSTALL_INC_DIR%\iconv" lib=%INSTALL_LIB_DIR% sodir=%INSTALL_BIN_DIR%
